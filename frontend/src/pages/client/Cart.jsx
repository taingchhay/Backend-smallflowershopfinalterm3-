              ...
              {cartItems.map((item) => (
                <div key={item.id} className="p-6">
                  <div className="flex items-center space-x-4">
                    <img
                      src={item.image || `https://images.pexels.com/photos/1164985/pexels-photo-1164985.jpeg?auto=compress&cs=tinysrgb&w=200`}
                      alt={item.name}
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-baby-pink-600 font-semibold mt-1">${item.price}</p>
                    </div>
